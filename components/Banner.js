  ...
  return (
    <div className="relative">
      ...
      <div className="flex flex-row mb-4">
        ...
        />
        <div className="flex flex-col justify-center h-100 bg-[#fafafa] w-[40%] pr-6 sm:pr-12">
          <h2 className="hidden md:line-clamp-2 md:text-lg md:block">
            {bannerProduct.name}
          </h2>
          <h3 className="text-xs line-clamp-2 font-extrabold tracking-tight text-gray-900 sm:mt-1 sm:text-2xl lg:text-3xl">
            {bannerProduct.details}
          </h3>
