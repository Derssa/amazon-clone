  ...
  return (
    <div className="bg-gray-100 min-h-[100vh]">
      ...
      <main className="max-w-screen-2xl min-h-screen mx-auto p-8 text-justify">
        ...
        <br />
        <p>
          Toutes les transactions d&apos;achat de comptes des jeux, de
          abonnements en ligne sont effectuées via des passerelles de paiement
          telles que PayPal ou Stripe qui utilisent le cryptage SSL. Ces
          passerelles de paiement sont sûres et sécurisées pour
          l&apos;utilisation de tous les types de cartes de crédit et de cartes
          de débit dans différents pays et vos coordonnées ne sont pas stockées
          pendant ce processus.
        </p>
        <br />
        <p>
          Si nous n&apos;avons pas livré votre produit après 24 heures, vous
          pouvez demander un remboursement. Votre achat étant un produit
          numérique, il est réputé &quot;utilisé&quot; après la livraison, et
          tous les achats effectués sur www.cheapgamesnetwork.com ne sont ni
          remboursables ni échangeables après le délivrement. Étant donné que
          les produits mis à disposition ici sont intangibles, il existe une
        ...
        <p>
          ...
          techniques, les conditions d&apos;achat et les offres de produits ou
          de services sans préavis.
        </p>
        <br />
        <br />
